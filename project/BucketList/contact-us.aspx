<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact-us.aspx.cs" Inherits="BucketList.contact_us" %>
              ...
              <div class="rd-navbar-main">
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="contact-us.aspx">Contact Us</a>
                    </li>
            ...
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <p class="box-contacts-link"><a href="tel:#">+91 9876543210</a></p>
                </div>
              </article>
            </div>
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"><a href="#">1234 Main Road,Mumbai 400001</a></p>
                </div>
              </article>
            </div>
            <div class="col-sm-8 col-md-6 col-lg-4">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"><a href="mailto:#">info@bucketlist.org</a></p>
                </div>
              </article>
            </div>
          </div>
